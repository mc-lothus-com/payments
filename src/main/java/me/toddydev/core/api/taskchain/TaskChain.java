package me.toddydev.core.api.taskchain;
 ...
 * previous com.redelegit.npc.task to the next com.redelegit.npc.task to use.
 *
...
public class TaskChain {
     ...
     */
    // Tells a com.redelegit.npc.task it will perform call back later.
    ...
    public TaskChain() {
        this.plugin = BukkitMain.getInstance(); // TODO: Change to get an instance to your plugin!
     ...
     * @param ticks # of ticks to delay before next com.redelegit.npc.task (20 = 1 second)
     * @return
     */
    ...
    /**
     * Fires off the next com.redelegit.npc.task, and switches between Async/Sync as necessary.
     */
    ...
    /**
     * Provides foundation of a com.redelegit.npc.task with what the previous com.redelegit.npc.task type should return
     * to pass to this and what this com.redelegit.npc.task will return.
     * @param <R> Return Type
    ...
    private abstract static class BaseTask<R, A> {
        ...
        /**
         * Called internally by Task Chain to facilitate executing the com.redelegit.npc.task and then the next com.redelegit.npc.task.
         * @param chain
         */
        ...
        /**
         * Tells the TaskChain you will manually invoke the next com.redelegit.npc.task manually using com.redelegit.npc.task.next(response);
         */
        public R async() {
        ...
        /**
         * Only to be used when paired with return this.async(); Must be called to execute the next com.redelegit.npc.task.
         *
            ...
            synchronized (this) {
                if (executed) {
                    throw new RuntimeException(
                            "This com.redelegit.npc.task has already been executed. return this.async()");
                }
            }
            chain.async = !Bukkit.isPrimaryThread(); // We don't know where the com.redelegit.npc.task called this from.
            chain.previous = resp;
            chain.nextTask();
        }
    }
     ...
     * value of a previous com.redelegit.npc.task.
     *
     * Last Tasks are for when you do not need to use a return type.
     *
     * A Generic com.redelegit.npc.task simply does not care about Previous Return or return
     * anything itself.
     *
